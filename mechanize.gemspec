...
Gem::Specification.new do |s|
  s.name = "mechanize"
  s.version = "2.1.1.20120126170143"
  ...
  s.extra_rdoc_files = ["Manifest.txt", "LICENSE.rdoc", "CHANGELOG.rdoc", "README.rdoc", "FAQ.rdoc", "EXAMPLES.rdoc", "GUIDE.rdoc"]
  ...
  s.test_files = ["test/test_mechanize_headers.rb", "test/test_mechanize_cookie.rb", "test/test_mechanize_link.rb", "test/test_mechanize_file_request.rb", "test/test_mechanize_form_multi_select_list.rb", "test/test_mechanize_parser.rb", "test/test_mechanize_util.rb", "test/test_multi_select.rb", "test/test_mechanize.rb", "test/test_mechanize_form_option.rb", "test/test_mechanize_form_textarea.rb", "test/test_mechanize_form.rb", "test/test_mechanize_http_content_disposition_parser.rb", "test/test_mechanize_file_connection.rb", "test/test_mechanize_form_encoding.rb", "test/test_mechanize_redirect_not_get_or_head_error.rb", "test/test_mechanize_form_field.rb", "test/test_mechanize_page_frame.rb", "test/test_mechanize_http_www_authenticate_parser.rb", "test/test_mechanize_subclass.rb", "test/test_mechanize_cookie_jar.rb", "test/test_mechanize_history.rb", "test/test_mechanize_page_meta_refresh.rb", "test/test_mechanize_form_keygen.rb", "test/test_mechanize_page_link.rb", "test/test_mechanize_file_saver.rb", "test/test_mechanize_file.rb", "test/test_mechanize_page_encoding.rb", "test/test_mechanize_page.rb", "test/test_mechanize_form_check_box.rb", "test/test_mechanize_form_file_upload.rb", "test/test_mechanize_http_auth_challenge.rb", "test/test_mechanize_download.rb", "test/test_mechanize_form_radio_button.rb", "test/test_mechanize_pluggable_parser.rb", "test/test_mechanize_redirect_limit_reached_error.rb", "test/test_mechanize_http_agent.rb", "test/test_mechanize_form_select_list.rb", "test/test_mechanize_form_image_button.rb", "test/test_mechanize_http_auth_realm.rb"]
